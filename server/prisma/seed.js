    ...
    for (let i = 0; i < 50; i++) {
        const product = await prisma.product.create({
            data: {
                ...
                description: `Uma bolsa ${productNames[i].toLowerCase()} da Gucci, perfeita para diversas ocasiões.`,
    ...
    for (let i = 0; i < createdProducts.length; i++) {
        await prisma.productImage.create({
            data: {
                ...
                url: `https://ximei-store.s3.sa-east-1.amazonaws.com/bolsa-${i + 1}.jpeg`,
                order: 1,
            },
        });
    }
